...
def run_command_sd(in_dir, out_dir, orig_in_dir):
    resolution = 512
    command = f'''accelerate launch diffusers_repo/examples/text_to_image/train_text_to_image.py \
...
run_command_sd(tmp_train_dir, args.out_dir, args.in_dir)
